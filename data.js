...
const questions = {
  ...
  Q2: {
    depth: 2,
    image: "images/q2.png",
    text: "Ти в самому замісі чи забезпечуєш цей заміс?",
    options: [
      { label: "Я і є заміс: зброя, штурм, мінус вороги.", next: "Q4" },
      { label: "Тримаю цей цирк до купи: рятую, лагоджу, підводжу снаряди.", next: "Q5" }
    ]
  },
  ...
  Q6: {
    ...
    options: [
      ...
      { label: "Як Аквамен, тільки з вибухівкою: гідрокостюми, глибина, секретні місії.", next: "combat_swimmer" }
    ]
  },
  ...
  Q7: {
    ...
    options: [
      ...
      { label: "Раш по центру: динаміка, штурм, стрілкотня впритул.", next: "marine" }
    ]
  },
  ...
  Q3: {
    ...
    options: [
      ...
      { label: "Менеджмент: люди, склади, папери та щоб усе працювало як годинник.", next: "Q11" }
    ]
  },
...
const results = {
  ...
  marine: {
    ...
    category: "Бойові та операторські посади",
    description: "Машина для розвалу облич ворогів. Там, де страшно іншим, морпіх відкриває двері з ноги. Штурми, висадки, максимальний адреналін і братерство, міцніше за броню. Якщо ти хочеш бути на вістрі атаки та маєш фізуху, щоб це вивезти – «Вірні завжди» чекають."
  },
  ...
  mechanic: {
    ...
    description: "Бог гайкового ключа. Здатен зібрати робочий двигун із двох неробочих, армованого скотча і матюків. Поки ти не скажеш «поїхали», війна стоятиме на паузі. Якщо твої руки вічно в мастилі й ти любиш повертати залізо з того світу – армії потрібен твій талант."
  },
  ...
  developer: {
    ...
    category: "Технічні та ІТ-посади",
    description: "Айтівець у пікселі. Твій код тепер не для чергового стартапу, а для систем наведення, управління військами та логістики. Жодних нудних дейліків із замовником – твій кастомер це ЗСУ, і фідбек тут вимірюється в знищеній техніці ворога."
  },
  ...
  psychologist_chaplain: {
    ...
    category: "Комунікації та морально-психологічне забезпечення",
    description: "Броня для психіки. Ти той, хто збирає докупи мізки й душі після пекла. Вмієш слухати, розуміти та знаходити слова, коли слів вже немає. Твоя зброя – емпатія і стабільність. Без тебе навіть сталеві термінатори можуть перегоріти."
  },
